...
class Utils {
    companion object {
        ...
        fun getPreviewRotation(activity: Activity, cameraId: Int): Int {
            ...
            val degrees = getRotationDegrees(activity)
        ...
        fun getFinalRotation(activity: Activity, currCameraId: Int, deviceOrientation: Int): Int {
            var rotation = getMediaRotation(activity, currCameraId)
            rotation += compensateDeviceRotation(currCameraId, deviceOrientation)
            return rotation % 360
        }
